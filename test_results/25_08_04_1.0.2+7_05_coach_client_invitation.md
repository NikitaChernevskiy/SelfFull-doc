...
| Name rejects < 2 characters | No limit |
| Name rejects > 50 characters | No limit |
| Name accepts letters / spaces / hyphens | ✅ |
| Name rejects numbers / symbols | No limit|
| *Email* input field present | ✅ |
| Email required error shown when empty | ✅ |
| Email rejects invalid format | No limit |
| Email accepts valid `x@y.z` format | ✅ |
| Email rejects < 6 characters | No limit |
| Email rejects > 254 characters | No limit |
...
| Invite button disabled while form invalid | Always active, error on miss |
...
| Email auto-filled (optional) matches invited email | No auto-fill |
...
| Password rejects < 8 characters | Minimum 6 symbols |
| Password requires ≥ 1 uppercase letter | No limit|
| Password requires ≥ 1 number | No limit|
| Password requires ≥ 1 symbol | No limit|
| Password strength bar shows “Medium” or higher at valid | No strength bar |
...
| Toggle cannot be turned ON (must remain OFF) | Can be turned on |
| **Create Account** button disabled while form invalid | Active, error on miss |
...
| Error message “User already exists.” displayed | Checks for exact email; considers upper and lower case letters as different symbols |