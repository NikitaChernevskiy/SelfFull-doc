...
| Course Name rejects < 3 characters | 1 char minimum|
| Course Name rejects > 100 characters | No limit |
| Course Name accepts letters, numbers, spaces, .,,:;!?-() | ✅ |
| Course Name rejects disallowed characters | No limits |
| Course Thumbnail uploader present | ✅ |
| Thumbnail accepts .jpg | ✅ |
| Thumbnail accepts .png | ✅ |
| Thumbnail rejects files > 10 MB | No limit |
| Thumbnail rejects resolution < 600 × 400 px | No limit |
| **Create/Save** button disabled while form invalid | Always enabled, error if miss |
...
| Chapter Title rejects < 3 characters | Single symbol minimum |
| Chapter Title rejects > 120 characters | No limit |
| Chapter Title accepts allowed punctuation | ✅ |
| Chapter Title rejects disallowed characters | No limit |
| **Add** button disabled until Title valid | Always enabled, error on miss|
...
| Module Title rejects < 3 characters | 1 symbol minimum|
| Module Title rejects > 120 characters | No limit|
...
| Description rejects > 2 000 characters | No limit|
| Rich-text toolbar available in Description | ✅ |
| Banner Image uploader present | ✅ |
| Banner accepts .jpg | ✅ |
| Banner accepts .png | ✅ |
| Banner rejects files > 10 MB | No limit |
| Banner rejects portrait (< landscape) ratio | No limit |
| Video upload option for file present | ✅ |
| Video upload accepts .mp4 | ✅ |
| Video upload accepts .mov | ✅ |
| Video upload rejects > 500 MB | No limit |
| Video upload rejects duration > 30 min | No limit |
| YouTube URL input present | ✅ |
| YouTube URL must match pattern | No limit|
| Upload Resources accepts .pdf | ✅ |
| Upload Resources accepts .docx | ✅ |
| Upload Resources accepts .pptx | ✅ |
| Upload Resources accepts .zip | ✅ |
| Each resource rejects > 100 MB | No limit |
| **Set Up Quiz** button present | ✅ |
| Tapping Set Up Quiz opens quiz builder | ✅ |
| **Add New Module** button disabled until required valid | Always active, error on miss|
...
| Question Text rejects < 5 characters | No limit |
| Question Text rejects > 255 characters | No limit |
| Option Text required per option | ✅ |
| Option Text rejects > 120 characters | No limit |
| Minimum 2 options enforced | 1 minimum |
| Maximum 6 options enforced | No limit |
| Correct Answer dropdown disabled until ≥ 2 options | Always active |
...
| Edit Scheduled datepresent | No edit button |
